...
# This is the create lambda function for creating a short url from a long url
...
def lambda_handler(event, context):
    ...
    body_new = '{"short_id":"https://' +short_url+'","long_url":"'+long_url+'"}'
    return {"statusCode": 200,"body": body_new}
